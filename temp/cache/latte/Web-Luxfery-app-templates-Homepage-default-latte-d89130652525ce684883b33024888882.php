<?php
// source: D:\Tvorba\Web\Luxfery\app/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5334197032', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block grid
//
if (!function_exists($_b->blocks['grid'][] = '_lb92710cb0e0_grid')) { function _lb92710cb0e0_grid($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
