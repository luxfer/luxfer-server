<?php
// source: D:\Tvorba\Web\Luxfery\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1213512053', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block script
//
if (!function_exists($_b->blocks['script'][] = '_lb0b9f948816_script')) { function _lb0b9f948816_script($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>		<script>
...
// block grid
//
if (!function_exists($_b->blocks['grid'][] = '_lbec89bd2d1d_grid')) { function _lbec89bd2d1d_grid($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
